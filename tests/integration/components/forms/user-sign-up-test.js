...
module('Integration | Component | forms/user-sign-up', function(hooks) {
  setupRenderingTest(hooks);

  test('it renders an empty user sign up form', async function(assert) {
    this.set('user', {
      email: '',
      firstName: '',
      lastName: '',
    ...
    await render(hbs`<Forms::UserSignUp @user={{this.user}} />`);
  ...
  test('it renders a filled out user sign up form', async function(assert) {
    this.set('user', {
