...
module('Integration | Component | menus/budget-item', function(hooks) {
  ...
  test('it renders a navigation menu', async function(assert) {
    await render(hbs`<Menus::BudgetItem />`);
  ...
  test('it renders budget details button', async function(assert) {
  ...
  test('it should not render budget details button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'budgets.show';
  ...
  test('it renders budget settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = '';
  ...
  test('it should not render budget settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'budgets.settings';
