...
module('Integration | Component | menus/deposit-item', function(hooks) {
  ...
  test('it renders', async function(assert) {
    await render(hbs`<Menus::DepositItem />`);
  ...
  test('it should not render deposit details button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'deposits.show';
  ...
  test('it renders deposit settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = '';
  ...
  test('it should not render deposit settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'deposits.settings';
