...
module('Integration | Component | menus/loan-payment-item', function(hooks) {
  ...
  test('it renders loan payment settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = '';
  ...
  test('it should not render loan payment settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'loan-payments.settings';
