...
module('Integration | Component | menus/user-item', function(hooks) {
  ...
  test('it renders a navigation menu', async function(assert) {
    await render(hbs`<Menus::UserItem />`);
  ...
  test('it renders user details button', async function(assert) {
  ...
  test('it should not render user details button', async function(assert) {
    const router = this.owner.lookup('service:router');
  ...
  test('it renders user settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = '';
  ...
  test('it should not render user settings button', async function(assert) {
    const router = this.owner.lookup('service:router');
    router.currentRouteName = 'users.settings';
